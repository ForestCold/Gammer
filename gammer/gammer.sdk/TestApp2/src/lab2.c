...
//iDate[]
u32 i1Date[] = {0xfe, 0xfe, 0x30, 0x30, 0x30, 0x30, 0xfe, 0xfe};
u32 i2Date[] = {0xfc, 0xfc, 0x60, 0x60, 0x60, 0x60, 0xfc, 0xfc};
u32 i3Date[] = {0xf8, 0xf8, 0xc1, 0xc1, 0xc0, 0xc0, 0xf8, 0xf8};
u32 i4Date[] = {0xf0, 0xf1, 0x83, 0x83, 0x81, 0x81, 0xf0, 0xf0};
u32 i5Date[] = {0xe1, 0xe3, 0x07, 0x07, 0x03, 0x03, 0xe1, 0xe0};
u32 i6Date[] = {0xc2, 0xc7, 0x0f, 0x0f, 0x07, 0x07, 0xc3, 0xc1};
u32 i7Date[] = {0x84, 0x8f, 0x1f, 0x1f, 0x0f, 0x0f, 0x87, 0x83};
u32 i8Date[] = {0x09, 0x1f, 0x3f, 0x3f, 0x1f, 0x1f, 0x0f, 0x06};
u32 i9Date[] = {0x12, 0x3f, 0x7f, 0x7f, 0x3f, 0x3f, 0x1e, 0x0c};

//loveDate[]
u32 love1Date[] = {0x48, 0xfc, 0xfe, 0xfe, 0xfc, 0xfc, 0x78, 0x30};
u32 love2Date[] = {0x90, 0xf8, 0xfc, 0xfc, 0xf8, 0xf8, 0xf0, 0x60};
...
//UDate[]
u32 U1Date[] = {0x86, 0x86, 0x86, 0x86, 0x86, 0x86, 0xfc, 0x78};
u32 U2Date[] = {0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0xf8, 0xf0};
u32 U3Date[] = {0x19, 0x19, 0x18, 0x18, 0x18, 0x18, 0xf1, 0xe1};
u32 U4Date[] = {0x33, 0x33, 0x30, 0x30, 0x30, 0x30, 0xe3, 0xc3};
u32 U5Date[] = {0x67, 0x67, 0x60, 0x60, 0x60, 0x60, 0xc7, 0x87};
u32 U6Date[] = {0xcf, 0xcf, 0xc1, 0xc1, 0xc1, 0xc1, 0x8f, 0x0f};
u32 U7Date[] = {0x9f, 0x9f, 0x83, 0x83, 0x83, 0x83, 0x1f, 0x1f};
u32 U8Date[] = {0x3f, 0x3f, 0x06, 0x06, 0x06, 0x06, 0x3f, 0x3f};
u32 U9Date[] = {0x7f, 0x7f, 0x0c, 0x0c, 0x0c, 0x0c, 0x7f, 0x7f};

//检测坏点矩阵
u32 Check1Date[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
u32 Check2Date[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
int  key;  //按键保存
int  sum = 2, over = 0, Score = 0, HighScore = 0;  //蛇的长度, 游戏结束(自吃或碰墙),，分数
...
int main(void)
{
	...
	{
		display_once(Check1Date, &s);
	}
	for (loop = 0; loop < 1999; loop++)
	{
		display_once(Check2Date, &s);
	}
